...
-- TODO: use :windcmd instead of specific bindings
vim.keymap.set("n", "<C-h>", "<C-w><C-h>", { desc = "Move focus to the left window" })
vim.keymap.set("n", "<C-l>", "<C-w><C-l>", { desc = "Move focus to the right window" })
vim.keymap.set("n", "<C-j>", "<C-w><C-j>", { desc = "Move focus to the lower window" })
vim.keymap.set("n", "<C-k>", "<C-w><C-k>", { desc = "Move focus to the upper window" })

vim.keymap.set("i", "jk", "<ESC>l<cmd>w<CR>", { desc = "Exit insert and write"})
...
require("lazy").setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- NOTE: Vue Support with ts/volar Hybrid-Mode:
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Mini Files
      -- Check out: https://github.com/echasnovski/mini.nvim/blob/main/readmes/mini-files.md
